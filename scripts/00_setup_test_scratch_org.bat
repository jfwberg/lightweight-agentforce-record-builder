...
call sf org create scratch --definition-file ../config/project-scratch-def.json --duration-days 7 --alias "larb_test" --set-default --no-namespace
...
call sf package install -p "04tP3000001bWRlIAM" -w 30 --target-org "larb_test"
...
call sf package install -p "04tP3000001cPZVIA2" -w 30 --target-org "larb_test"
call sf org assign permset --name "Lightweight_Agentforce_Record_Builder_Admin" --target-org "larb_test"
