...
import addChildSObjectAndFields from '@salesforce/apex/SchemaActionsCtrl.addChildSObjectAndFields';


export default class AddChildSObjectToSchemaModal extends LightningModal {
     ...
     ** **************************************************************************************************** **/
    handleAddChildSObjectAndFields(){
        try{
            // Show spinner
            this.loading = true;

            // Execute Apex
            addChildSObjectAndFields({
                recordId               : this.content, // Note this is a Mapped_sObject__c field
